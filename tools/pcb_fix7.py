"""Fix round 7: PMOD8 ducks under the +3.3V column on B.Cu; restore column."""
import pcbnew
...
DEL = [(165.8, 86.4, 170.4, 86.4), (170.4, 86.4, 170.4, 79.4),
       (170.4, 79.4, 171.96, 79.4)]
...
route("PMOD8", F, [(165.8, 86.4), (168.45, 86.4)])
via("PMOD8", 168.45, 86.4)
route("PMOD8", B, [(168.45, 86.4), (170.7, 86.4)])
via("PMOD8", 170.7, 86.4)
route("PMOD8", F, [(170.7, 86.4), (170.7, 79.4), (171.96, 79.4)])

PTS = [(140.40, 90.30), (148.70, 90.30), (150.80, 92.20), (155.60, 92.20),
       (155.60, 82.90), (157.90, 82.90), (157.90, 92.20), (168.80, 92.20),
       (168.80, 75.90), (170.20, 75.90), (170.20, 95.10), (140.40, 95.10)]
for z in b.Zones():
